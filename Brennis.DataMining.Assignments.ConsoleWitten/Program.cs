using System;
using System.Data;
using Brennis.DataMining.Assignments.CommonWitten;
using Brennis.DataMining.Assignments.Witten.CsvReader;
using Brennis.DataMining.Assignments.Witten.ID3;
using Brennis.DataMining.Assignments.Witten.Likelihood;
using Brennis.DataMining.Assignments.Witten.OneRAlgorithm;
using Brennis.DataMining.Assignments.Witten.ZeroRAlgorithm;

namespace Brennis.DataMining.Assignments.ConsoleWitten
{
